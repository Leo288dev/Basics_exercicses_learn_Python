...
#--------------------------------------------------- BL DEPÓSITO ------------------------------------------------------
    if menu == 'A':
        ...
        dep = float(input('Valor à depositar:  ').replace('.', '').replace(',', '.'))
        print('')
        if dep <= 0:
            print('*' * 50)
...
#---------------------------------------------BL SAQUE -----------------------------------------------------------------
        ...
        print(F'Saldo atual R$ {deposito :.2f}')
        saq = float(input('Digite o valor à sacar R$ ').replace('.', '').replace(',', '.'))
        if saq != 0:
            if saq <= deposito:
                cont += 1
                if cont <= 3:
                    print('')
                    print(f'Saque de R$ {saq :.2f} efeutado com sucesso !!! ')
                    deposito -= saq
                    print(f'Saldo atual R$ {deposito :.2f}')
